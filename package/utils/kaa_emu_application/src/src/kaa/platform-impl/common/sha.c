...
kaa_error_t ext_calculate_sha_hash1(const char *data, size_t data_size, kaa_digest digest)
{
...
kaa_error_t ext_copy_sha_hash1(kaa_digest_p dst, const kaa_digest_p src)
{
