...
Section: net
Category: Network
Title: Complete open source PBX, v11.18.0
Maintainer: Jiri Slachta <slachta@cesnet.cz>
Source: asterisk-11.18.0.tar.gz
License: GPL-2.0
...
Submenu: Telephony
Version: 11.18.0-3
Depends: +libc +SSP_SUPPORT:libssp +USE_GLIBC:librt +USE_GLIBC:libpthread asterisk11 +PACKAGE_asterisk11-chan-dahdi:dahdi-tools-libtonezone +PACKAGE_asterisk11-chan-dahdi:kmod-dahdi
Conflicts: 
Menu-Depends: 
Provides: 
Build-Depends: libxml2/host
